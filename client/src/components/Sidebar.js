...
function Sidebar() {
  ...
  <li><Link to="/" className="title">Dashboard</Link></li>
  ...
  <li className="dropdown-wrapper">
    <NavDropdown title="Allotments" id="basic-nav-dropdown" >
      <NavDropdown.Item ><Link to="/allotment"> Requests </Link></NavDropdown.Item>
...
*/}
  <li className="dropdown-wrapper">
    <NavDropdown title="Reports" id="basic-nav-dropdown" >
      ...
      <NavDropdown.Item ><Link to="/commission-report">Commision Report</Link></NavDropdown.Item>
      <NavDropdown.Item ><Link to="/inventory-report">Inventory Report</Link></NavDropdown.Item>
      <NavDropdown.Item ><Link to="/discount-report">Discount Report</Link></NavDropdown.Item>
      <NavDropdown.Item ><Link to="/sales-report">Sales Report</Link></NavDropdown.Item>
      ...
      <NavDropdown.Item ><Link to="/transfer-report">Transfer Report</Link></NavDropdown.Item>
    </NavDropdown>
  </li>
